...
const deployFunc: DeployFunction = async (hre: HardhatRuntimeEnvironment) => {
  ...
  const args = [
    ...
    11083876, // finalized slot period = 1353
    '0xb549827c59146c49262326cbc4747602e1dc45ab6af675fa01c80a47f8a676e8', // period 1353 sha root
    '0x23fe301686e7607e52750afd172da048840af65eac8e9cc246a677d0085e8812', // period 1353 poseidon root
    verifier.address
  ];
